...
# openssl
if true; then
  curl -L -O --output-dir $BUILD_DIR/ https://www.openssl.org/source/openssl-3.0.14.tar.gz
  tar -xvf $BUILD_DIR/openssl-3.0.14.tar.gz -C $BUILD_DIR
  cd $BUILD_DIR/openssl-3.0.14
