...
# tcl
if true; then
  curl -L -O --output-dir $BUILD_DIR http://prdownloads.sourceforge.net/tcl/tcl8.6.14-src.tar.gz
  tar -xvf $BUILD_DIR/tcl8.6.14-src.tar.gz -C $BUILD_DIR
  cd $BUILD_DIR/tcl8.6.14/unix
